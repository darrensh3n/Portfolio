...
export default function FloatingToolbar() {
  ...
  return (
    <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-50">
      <div className="bg-white/90 dark:bg-slate-800/90 backdrop-blur-md border border-cyan-200 dark:border-slate-700 rounded-full px-6 py-3 shadow-lg">
        <div className="flex items-center space-x-6">
          ...
          {/* Divider */}
          <div className="w-px h-6 bg-cyan-300 dark:bg-slate-600"></div>
